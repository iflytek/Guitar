...
package com.iflytek.guitar.core.util.hyperloglog;
...
public class HyperLogLog implements ICardinality, Serializable {
    ...
    // default constructor with 0.01 deviation
    // add by iflytek
    public HyperLogLog() {
        this(0.01);
    }
    ...
    public static class Builder implements IBuilder<ICardinality>, Serializable {
        ...
        public static HyperLogLog build(DataInput serializedByteStream) throws IOException {
            ...
            return new HyperLogLog(log2m,
                    new RegisterSet(1 << log2m, com.clearspring.analytics.util.Bits.getBits(serializedByteStream, byteArraySize)));
        }
    }
